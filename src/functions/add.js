 ...
 * @return {(number|number[])} The sum of all numbers in `args` if all arguments are numbers. Otherwise, an array of sums of the elements at each index, including all scalar numbers in `args` in the calculation at each index.
