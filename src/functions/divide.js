 ...
 * @return {(number|number[])} The quotient of `a` and `b` if both are numbers. If `a` or `b` is an array, returns an array with the quotients applied index-wise to each element.
